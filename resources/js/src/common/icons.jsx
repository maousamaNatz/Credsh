export const IconCamera = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
        <path fill="currentColor" d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-1.586a1 1 0 01-.707-.293l-1.121-1.121A2 2 0 0011.172 3H8.828a2 2 0 00-1.414.586L6.293 4.707A1 1 0 015.586 5H4z" />
    </svg>
);

export const IconHeart = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
        <path
            fill="currentColor"
            fillRule="evenodd"
...
export const IconUtensils = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
        <path
            fill="currentColor"
            fillRule="evenodd"
...
export const IconGem = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
        <path
            fill="currentColor"
            fillRule="evenodd"
            d="M10 3l6 6v8H4v-8l6-6zm0 2.828L5.828 10H14.172L10 5.828z"
            clipRule="evenodd"
        />
    </svg>
);

export const IconMap = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
        <path
            fill="currentColor"
            fillRule="evenodd"
...
export const IconCalendar = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
        <path
            fill="currentColor"
            fillRule="evenodd"
...
export const IconUsers = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg className={`${size} ${color} ${className}`} viewBox="0 0 20 20">
...
export const IconMessage = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg
...
export const IconCart = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
    <svg
        className={`${size} ${color} ${className}`}
        viewBox="0 0 24 24"
        fill="none"
...
export const IconBell = ({ size = "w-6 h-6", color = "text-gray-800", className }) => (
  <svg
    className={`${size} ${color} ${className}`}
    fill="none"
    viewBox="0 0 24 24"
