        ...
        <Card>
            ...
            <div className="p-6">
                ...
                <div className="flex items-center mb-4">
                    ...
                    <span className="ml-2 text-sm text-gray-500">({vendor.reviews} ulasan)</span>
                </div>
                <div className="flex items-center justify-between">
                    <div>
                        <span className="text-sm text-gray-500">Mulai dari</span>
                        <p className="text-lg font-bold text-pink-600">Rp {vendor.harga_mulai}</p>
                    </div>
                    <Link
            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <img src={article.author_avatar} alt={article.author} className="w-8 h-8 rounded-full" />
    ...
    return (
        <Card className="p-6">
            ...
            <blockquote className="relative">
                <svg className="absolute top-0 left-0 transform -translate-x-6 -translate-y-8 h-16 w-16 text-gray-100" fill="currentColor" viewBox="0 0 32 32">
